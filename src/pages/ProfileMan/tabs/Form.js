  ...
  <div>
    <Tabs activeTab='about'>
      <TabList>
        ...
        <Tab component={CustomTab} label='My Auctions' id='Section2' />
        <Tab component={CustomTab} label='My RFx' id='Section3' />
        <Tab component={CustomTab} label='Organization Profile' id='Section4' />
        <Tab component={CustomTab} label='Business Dashboard' id='Section5' />
      </TabList>
      <TabList>
