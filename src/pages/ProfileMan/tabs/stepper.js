  ...
  function getStepContent(stepIndex) {
    ...
    switch (stepIndex) {
      case 0:
        return (         
          <>
          <h1>Section 1 : Company & Contact Details</h1>
            <Form>
      ...
      case 1:
        return(<>
          <h1>Section 2 : General Information</h1>
            <Form>
              <Grid container spacing={3}>
      ...
      case 2:
        return (
          <>
          <h1>Section 3: Banking Details</h1>
            <Form>
            <Grid container spacing={3}>
                <Grid item xs={6}>
                    <Controls.Input
      ...
      case 3:
        return(
       <>
       <h1>Section 4 : Technical Capabilities and Information on Goods / Services Offered</h1>
         <Form>
           <Grid container spacing={3}>
